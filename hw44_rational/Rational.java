 ...
 ******************************/
//TheBulldozers
// Rohan Ahammed and Adrian Kloskowski
// APCS1 p08
// HW44 -- implementing an interface, boolean short-circuiting (Rational Equality)
// 2017-12-01f
...
public class Rational implements Comparable
{
  ...
  public boolean equals( Object other )
  {
    ...
    //...thus allowing for direct comparison of attributes
      Rational realOther = (Rational) other; // typecasts other
      reduce();
            realOther.reduce();//makes sure to reduce Rational other

    return (this == other)||//if this and other are aliases, they have the same memory allocation and this statement works. this shortcircuits and num/denom are not checked
	(this._numerator == realOther._numerator 
	 && this._denominator == realOther._denominator);//checks for rational equivalence
  }//end equals()
  ...
  public int compareTo( Object other )
  {
    // If other is not a Rational, throw an exception
	  ...
	  throw new ClassCastException("Please use instances of Rational as arg");
      }
    // This will exit the function, generating a runtime error
      Rational realOther = (Rational) other; // typecasts other in this method also
      this.equals(other);
      return (this._numerator * realOther._denominator) - (realOther._numerator * this._denominator);//based on old implementation of compareTo method
  ...
  public static void main( String[] args )
  {
      ...
      // System.out.println( "s > y: " +  s.compareTo(y) ); Throwing exception worked
      ...
      System.out.println( "u.equals(v): " + u.equals(v) );//false
       /*~~~v~~~~~~~~~~down~goer~3~~~~~~~~~~~~~v~~~~~
      ~~~~~|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|~~~~~*/
  }
